...
module exe_unit_w15_rtl(i_oper, i_argA, i_argB, i_clk, i_rsn, o_result, o_status);
  ...
  assign _008_ = _000_ & _003_;
  assign _009_ = i_argB[1] | i_argB[0];
  assign _010_ = i_oper[1] & _009_;
  ...
  assign _029_ = _004_ & _011_;
  assign _030_ = _001_ & i_argB[0];
  assign _031_ = i_argA[1] | _030_;
  assign _032_ = _029_ & _031_;
  assign _033_ = i_argA[0] & i_argA[3];
  assign _034_ = i_argA[1] ^ _033_;
  assign _035_ = _007_ & _034_;
  assign s_result[1] = _032_ | _035_;
  assign _036_ = i_argB[1] & _002_;
  ...
  assign _044_ = i_argB[1] & i_argB[0];
  assign _045_ = i_argA[3] | _044_;
  assign _046_ = i_argA[2] | _040_;
  assign _047_ = i_argA[3] & _007_;
  assign _048_ = _046_ & _047_;
  assign _049_ = _029_ | _048_;
  assign s_result[3] = _045_ & _049_;
  assign _050_ = s_result[2] & s_result[3];
  assign _051_ = s_result[2] ^ s_result[3];
  assign _052_ = s_result[0] & s_result[1];
  assign _053_ = s_result[0] ^ s_result[1];
  assign s_status[0] = _051_ ^ _053_;
  assign s_status[2] = _050_ & _052_;
  assign _054_ = _003_ | i_oper[1];
  assign _055_ = i_oper[0] | _011_;
  assign _056_ = ~_055_;
  assign s_status[3] = _054_ & _056_;
